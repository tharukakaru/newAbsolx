...
export function getTransitionTextureResolution( texture, sizes ) {
    ...
    const useHeightDominant = sizes.height / sizes.width > imageAspect;

    const a1 = useHeightDominant ? ( sizes.width / sizes.height ) * imageAspect : 1;
    const a2 = useHeightDominant ? 1 : ( sizes.height / sizes.width ) / imageAspect;
